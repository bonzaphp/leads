...
namespace bonza\leads\extend;

use bonza\leads\exception\JsonException;
...
class Curl
{
     ...
     */
    public function sendRequest($url, $method = 'post', $data = '', $headers = ['Accept-Charset: utf-8']): array
    {
        $ch = curl_init(); //初始化
        //设置URL和相应的选项
